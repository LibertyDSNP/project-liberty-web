  ...
  return (
    <div className="CodeOfConduct__block">
      ...
      <p>
        ...
        <a href="mailto:coc@projectliberty.io"> coc@projectliberty.io</a>. All
      ...
      <p>
        <b>Consequence: </b>A warning with consequences for continued behavior.
      ...
      <p>
        <b>Consequence:</b> A temporary ban from any sort of interaction or
